...
// Moving pages is handled by edit.php (page management)
if ($data = $mform->get_data()) {
    $last_page = \mod_simplelesson\local\pages::count_pages(
      $moduleinstance->id);
    ...
    \mod_simplelesson\local\pages::add_page_record($data, $modulecontext);
