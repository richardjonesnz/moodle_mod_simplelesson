...
/**
 * Event observer for simplelesson plugin
 *
...
/**
 * Event observer for mod_simplelesson
 *
 * @package    mod_simplelesson
 * @copyright 2015 Justin Hunt, modified 2018 Richard Jones https://richardnz.net
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class event_observer{
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
       global $DB;
		//MOD_SIMPLELESSON_TABLE should be deleted elsewhere
		...
		$ret = $DB->delete_records(MOD_SIMPLELESSON_USERTABLE,array('courseid'=>$event->objectid));
		return $ret;
	}
}
