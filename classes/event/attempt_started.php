...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has started an attempt with the id '$this->objectid' in the simplelesson activity with course module id '$this->contextinstanceid'.";
    }
}